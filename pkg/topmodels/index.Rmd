...
<img alt="Probabilistic model evaluation with topmodels: Rootogram"     src="man/figures/rootogram-1.svg" style="border:10px solid transparent" width="33%">
<img alt="Probabilistic model evaluation with topmodels: PIT Histogram" src="man/figures/pithist-1.svg"   style="border:10px solid transparent" width="33%">
<img alt="Probabilistic model evaluation with topmodels: Reliagram"     src="man/figures/reliagram-1.svg" style="border:10px solid transparent" width="33%">
