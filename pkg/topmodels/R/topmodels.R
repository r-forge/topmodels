...
## - Z: p4() generic plus flexible p4_setup() [done]
## - JM: p4.crch() with new p4_setup() infrastructure.
...
## - JM/Z/.../CK/IK/.../SW/MS/GS/???: p4 methods for betareg, countreg, glm, gamlss, mgcv::gam, ...
