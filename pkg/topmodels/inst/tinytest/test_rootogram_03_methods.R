...
expect_identical(sort(names(r1r2)), sort(c(names(r1), tmp_additional_variables)))
...
expect_identical(sort(names(r1r2r3)), sort(c(names(r1), tmp_additional_variables)))
...
expect_identical(sort(names(tbl_r1r2r3)), sort(c(names(tbl_r1), tmp_additional_variables)))
