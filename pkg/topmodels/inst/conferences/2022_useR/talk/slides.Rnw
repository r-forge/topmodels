...
\textbf{Convenience function:} \code{prodist(m)}
...
\textbf{Rootogram:} Compares observed and average expected frequencies.
...
\textbf{topmodels:} Fully leverage S3 infrastructure from \emph{distributions3}.
