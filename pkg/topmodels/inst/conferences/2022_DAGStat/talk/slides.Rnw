...
rootogram(m, style = "standing", scale = "raw", fitted = TRUE, ref = FALSE, plot = "ggplot2", fitted_size = 1.25)
@
\end{center}
\end{frame}
...
rootogram(m, style = "standing", scale = "sqrt", fitted = TRUE, ref = FALSE, plot = "ggplot2", fitted_size = 1.25)
@
\end{center}
\end{frame}
...
rootogram(m, style = "hanging", scale = "sqrt", fitted = TRUE, ref = TRUE, plot = "ggplot2", fitted_size = 1.25)
@
\end{center}
\end{frame}
...
\item[] $\text{y}_i \sim \, \text{Logistic}\big(\mu_i = \beta_{0} + \beta_1 \cdot \text{ensmean}_i, \, \sigma_i = \exp(\gamma_0 + \gamma_1 \cdot \text{enssd}_i)\big)$
\end{itemize}
...
ggplot2::autoplot(c(r1, r2), fitted_size = 1.25)
@
\end{center}
\end{frame}
