...
\begin{itemize}
\item Not just prediction of the mean but model entire probability distribution.
...
\begin{itemize}
\item Scoring rules for evaluation the predictive performance, e.g., using the log-score or the (continuous) ranked probability score.
\item Visualizations especially suitable for evaluating potential lack of fit.
\end{itemize}
...
\textbf{Regression:}
\begin{itemize}
\item Difference in estimated log-ability of the competing teams as covariable:
\item[] $\log(\lambda_i) = \beta_0 + \beta_1 \cdot \text{diff\_logability}_i$
\end{itemize}
...
rootogram(m, style = "standing", scale = "raw", fill = "darkgray", col = "black", fitted = FALSE, xlab = "Goals")
@
...
rootogram(m, style = "standing", scale = "raw", fill = "darkgray", col = "black", fitted = TRUE, xlab = "Goals")
@
...
rootogram(m, style = "standing", scale = "raw", fitted = FALSE, ref = FALSE, plot = "ggplot2", xlab = "Goals")
@
\end{center}
\end{frame}
...
rootogram(m, style = "standing", scale = "raw", fitted = TRUE, ref = FALSE, plot = "ggplot2", fitted_size = 1.25, xlab = "Goals")
@
\end{center}
\end{frame}
...
rootogram(m, style = "standing", scale = "sqrt", fitted = TRUE, ref = FALSE, plot = "ggplot2", fitted_size = 1.25, xlab = "Goals")
@
\end{center}
\end{frame}
...
rootogram(m, style = "hanging", scale = "sqrt", fitted = TRUE, ref = TRUE, plot = "ggplot2", fitted_size = 1.25, xlab = "Goals")
@
\end{center}
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<fifa_pithist1a, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
set.seed(3)
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<fifa_pithist1b, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
set.seed(3)
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<fifa_pithist1c, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
set.seed(3)
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<fifa_pithist3a, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
set.seed(5)
pithist(m, nsim = 1, type = "random", fill = "darkgray", col = "black", ref = TRUE, simint = FALSE, confint = TRUE, alpha = 1, ylim = c(NA, 1.788086), ref_size = 1, confint_size = 1, plot = "ggplot2")
@
\end{center}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<fifa_pithist3b, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
set.seed(5)
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<fifa_pithist_norm1a, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
set.seed(1000)
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<fifa_pithist_norm1b, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
set.seed(1000)
...
\item[] $\mu_i = \, \beta_{0} + \beta_1 \cdot \text{ensmean}_i$
\item Heteroscedastic censored regression with a logistic distribution assumption:
\item[] $\text{y}_i \sim \, \text{Logistic}\big(\hat \mu_i = \beta_{0} + \beta_1 \cdot \text{ensmean}_i, \, \hat \sigma_i = \exp(\gamma_0 + \gamma_1 \cdot \text{enssd}_i)\big)$
\end{itemize}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_scatter1a, fig=TRUE, echo=FALSE, height=6.6, width=7.8>>=
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_scatter1b, fig=TRUE, echo=FALSE, height=6.6, width=7.8>>=
plot(rain ~ ensmean, data = RainIbk, pch = 19, ylab = "Rain", col = gray(0, alpha = 0.2))
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_scatter1c, fig=TRUE, echo=FALSE, height=6.6, width=7.8>>=
plot(rain ~ ensmean, data = RainIbk, pch = 19, ylab = "Rain", col = gray(0, alpha = 0.2))
abline(coef(m_lm)[1:2], col = 3, lwd = 4)
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_rootogram, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_pithist1, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_pithist2, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_qqrplot, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_wormplot, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_pithist3, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
