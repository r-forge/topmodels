...
pithist(m_lm, type = "random", nsim = 10, fill = "darkgray", alpha = 1, col = "black",
  expected = FALSE, confint = FALSE, simint = FALSE)
@
...
set.seed(0)
pithist(m_lm, type = "random", nsim = 10, scale = "normal",
  fill = "darkgray", col = "black", alpha = 1, xlab = "(Randomized) quantile residuals",
  expected = FALSE, confint = FALSE, simint = FALSE)
@
