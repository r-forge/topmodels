...
<<echo=FALSE, results=hide>>=
#### cross validation rain
if(file.exists("Data/topmodels_axams.rda")){
  load("Data/topmodels_axams.rda")
} else {
  source("fit_n_evaluate_models.R")  
  load("Data/topmodels_axams.rda")
}
@
...
install.packages("disttree", repos = "https://R-Forge.R-project.org")
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_df_qqrplot, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
autoplot(qq1_df1)
@
\end{center}
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_df_pithist, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
autoplot(pit1_df1, ref = 2, confint = 2, size = 0.7)
@
\end{center}
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_df_rootogram, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
autoplot(root1_df1)
@
\end{center}
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_df_reliagram, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
autoplot(rel1_df1)
@
\end{center}
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_df_wormplot, fig=TRUE, echo=FALSE, height=5.6, width=7.8>>=
autoplot(worm1_df1)
@
\end{center}
\end{frame}
...
<<echo=TRUE,eval=FALSE>>=
linear <- lm(robs ~ tppow_mean, data = RainAxams)
@
...
<<echo=TRUE,eval=FALSE>>=
rootogram(linear, plot = FALSE) |>
  autoplot(legend = TRUE)
@

\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_lm_rootogram1, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
autoplot(c(linear = root1_lm1), legend = TRUE)
@
\end{center}
...
<<echo=TRUE,eval=FALSE>>=
rootogram(linear, plot = FALSE, breaks = -9:14) |>
  autoplot(legend = TRUE)
@

\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_lm_rootogram, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
autoplot(c(linear = root1b_lm1), legend = TRUE)
@
\end{center}
...
<<echo=TRUE,eval=FALSE>>=
c(rootogram(forest, breaks = -9:14), rootogram(linear, breaks = -9:14)) |>
  autoplot(legend = TRUE)
@

\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_comp_rootogram, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
autoplot(c(forest = root1b_df1, linear = root1b_lm1))
@
\end{center}
...
<<echo=TRUE,eval=FALSE>>=
pithist(forest, plot = FALSE) |>
  autoplot(legend = TRUE)
@

\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_lm_pithist1_hist, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
autoplot(c(forest = pit1_df1), legend = TRUE, style = "histogram", ylim = c(0, 1.7), ref = 2, confint = 2, size = 0.7)
@
\end{center}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_lm_pithist1_lines, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
autoplot(c(forest = pit1_df1), legend = TRUE, style = "lines", ylim = c(0, 1.7))
@
\end{center}
...
<<echo=TRUE,eval=FALSE>>=
c(pithist(forest, plot = FALSE), pithist(linear, plot = FALSE)) |>
  autoplot(legend = TRUE, style = "lines", single_graph = TRUE, col = 1:2)
@

\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_lm_pithist2, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
autoplot(c(forest = pit1_df1, linear = pit1_lm1),
          style = "lines", single_graph = TRUE, legend = TRUE, col = 1:2, confint = c(TRUE, FALSE), ylim = c(0, 1.7))
@
\end{center}
...
<<echo=TRUE,eval=FALSE>>=
qqrplot(forest, plot = FALSE) |>
  autoplot(legend = TRUE)
@

\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_lm_qqrplot1, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
autoplot(c(forest = qq1_df1), legend = TRUE, ylim = c(-3.95, 4.95))
@
\end{center}
...
<<echo=TRUE,eval=FALSE>>=
c(qqrplot(forest, plot = FALSE), qqrplot(linear, plot = FALSE)) |>
  autoplot(legend = TRUE, single_graph = TRUE, col = 1:2)
@

\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_lm_qqrplot2, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
autoplot(c(forest = qq1_df1, linear = qq1_lm1), legend = TRUE, col = 1:2, ylim = c(-3.95, 4.95), single_graph = TRUE)
@
\end{center}
