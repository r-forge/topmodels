...
<<rain_cross_axams_crps_skills_score, fig=TRUE, echo=FALSE, height=5.0, width=7.4>>=
#par(mar = c(2.5,2,1,2))
...
m_lm <- lm(robs ~ tppow_mean, data = RainAxams)
m_df <- distforest(robs ~ ., 
...
<<rain_topmodels_df_rootogram, fig=TRUE, echo=FALSE, height=5.3, width=8.8>>=
autoplot(root1_lm1, legend = TRUE)
@
\end{center}

\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
rootogram(m_lm, plot = "ggplot2", legend = TRUE)
@
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_lm_rootogram, fig=TRUE, echo=FALSE, height=5.3, width=8.8>>=
autoplot(root1_df1, legend = TRUE)
@
\end{center}

\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
rootogram(m_df, plot = "ggplot2", legend = TRUE)
@
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_qqrplot, fig=TRUE, echo=FALSE, height=5.3, width=8.8>>=
autoplot(c(qq1_lm1, qq1_df1), single_graph = TRUE, legend = TRUE, col = 1:2)
@
\end{center}

\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
q_df <- qqrplot(m_df, plot = FALSE)
q_lm <- qqrplot(m_lm, plot = FALSE)
autoplot(c(q_lm, q_df), single_graph = TRUE, legend = TRUE, col = 1:2)
@
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_df_pithist, fig=TRUE, echo=FALSE, height=5.3, width=8.8>>=
autoplot(pit1_lm1, ref = 2, confint = 2, legend = TRUE)
@
\end{center}

\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
pithist(m_lm, plot = "ggplot2")
@
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_lm_pithist, fig=TRUE, echo=FALSE, height=5.3, width=8.8>>=
autoplot(pit1_df1, ref = 2, confint = 2, legend = TRUE)
@
\end{center}

\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
pithist(m_df, plot = "ggplot2", legend = TRUE)
@
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_reliagram, fig=TRUE, echo=FALSE, height=5.3, width=8.8>>=
autoplot(c(m_lm = rel1_lm1, m_df = rel1_df1), single_graph = TRUE, legend = TRUE, col = 1:2, confint = 1:2)
@
\end{center}

\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
r_df <- reliagram(m_df, plot = FALSE)
r_lm <- reliagram(m_lm, plot = FALSE)
autoplot(c(r_lm, r_df), single_graph = TRUE, legend = TRUE, ...)
@
\end{frame}
