...
\URL{http://topmodels.R-Forge.R-project.org}
...
\begin{center}
\vspace{-0.6cm}
\setkeys{Gin}{width=0.575\textwidth}
...
% autoplot(c(forest = root1_df1), legend = TRUE)
% @
% \end{center}
% 
% \vspace*{-0.3cm}
% <<echo=TRUE,eval=FALSE>>=
% rootogram(forest, plot = "ggplot2", legend = TRUE)
% @
% \end{frame}
...
\begin{itemize}
  \item Homoscedastic (probability) model.
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_lm_qqrplot, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
autoplot(c(linear = qq1_lm1, forest = qq1_df1),
         single_graph = TRUE, legend = TRUE, col = 1:2)
@
\end{center}

\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
c(qqrplot(linear, plot = FALSE), qqrplot(forest, plot = FALSE)) |>
  autoplot(single_graph = TRUE, legend = TRUE, col = 1:2)
@
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_lm_pithist, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
autoplot(c(linear = pit1_lm1, forest = pit1_df1),
          single_graph = TRUE, legend = TRUE, col = 1:2, confint = c(TRUE, FALSE))
@
\end{center}

\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
c(pithist(linear, plot = FALSE), qqrplot(forest, plot = FALSE)) |>
  autoplot(style = "lines", single_graph = TRUE, legend = TRUE, col = 1:2)
@
\end{frame}
...
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_lm_rootogram, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
autoplot(c(linear = root1_lm1, forest = root1_df1))
@
\end{center}

\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
c(rootogram(linear, plot = FALSE), rootogram(forest, plot = FALSE)) |>
  autoplot()
@
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_lm_reliagram, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
autoplot(c(linear = rel1_lm1, forest = rel1_df1),
...
\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
c(reliagram(linear, plot = FALSE), reliagram(forest, plot = FALSE)) |>
  autoplot(single_graph = TRUE, legend = TRUE, col = 1:2, confint = 1:2)
@
\end{frame}
...
\small{\url{http://topmodels.R-Forge.R-project.org/}}\\ 
