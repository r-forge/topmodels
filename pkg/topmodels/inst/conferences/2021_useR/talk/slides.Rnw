...
<<rain_topmodels_df_rootogram, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
...
\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
rootogram(linear, plot = "ggplot2", legend = TRUE)
@
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_qqrplot, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
...
\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
qq_forest <- qqrplot(forest, plot = FALSE)
qq_lm <- qqrplot(linear, plot = FALSE)
autoplot(c(qq_lm, qq_forest), single_graph = TRUE, legend = TRUE, col = 1:2, ...)
@
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_df_pithist, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
autoplot(c(linear = pit1_lm1), ref = 2, confint = 2, legend = TRUE, size = 0.7)
@
\end{center}

\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
pithist(linear, plot = "ggplot2")
@
\end{frame}
...
autoplot(c(forest = pit1_df1), ref = 2, confint = 2, legend = TRUE, size = 0.7)
@
\end{center}

\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
pithist(forest, plot = "ggplot2", legend = TRUE)
@
\end{frame}
...
\begin{center}
\setkeys{Gin}{width=0.65\textwidth}
<<rain_topmodels_reliagram, fig=TRUE, echo=FALSE, height=5., width=8.8>>=
autoplot(c(linear = rel1_lm1, forest = rel1_df1), single_graph = TRUE, legend = TRUE, col = 1:2, confint = 1:2)
@
\end{center}

\vspace*{-0.3cm}
<<echo=TRUE,eval=FALSE>>=
rel_forest <- reliagram(forest, thresholds = 0, plot = FALSE)
rel_lm <- reliagram(linear, thresholds = 0, plot = FALSE)
autoplot(c(rel_lm, rel_forest), single_graph = TRUE, legend = TRUE, ...)
@
\end{frame}
