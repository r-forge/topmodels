...
Given an observational vector of a discrete random variable $y_i (i= 1, \dots,
...
distributional model $\mathcal{f}( \cdot )$ and $w_i (i= 1, \dots, n)$ being
...
$\mathcal{f}( \cdot )$ with estimated parameters $\hat{\boldsymbol{\theta}}_{i}
