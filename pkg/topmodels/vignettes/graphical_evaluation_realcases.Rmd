...
## heteroscedastic truncated regression with a logistic distribution assumption
...
```{r crch validation, echo = FALSE, fig.height = 6, out.width = "100%", fig.align = "center"}
par(mfrow = c(1, 1), bg = "#f7f7f7")

plot(rain~ensmean, data = RainIbk, pch = 19, col = gray(0, alpha = 0.2))
abline(coef(LM)[1:2], col = 2, lwd = 2)
abline(coef(CRCH)[1:2], col = 3, lwd = 2)
abline(coef(TRCH)[1:2], col = 4, lwd = 2)

legend("topright", lwd = c(1, 1, 1), lty = c(1, 1, 1), col = c(2, 3, 4), 
  c("LM", "CRCH", "TRCH"), bty = "n")
...
#### Linear model 
```{r topmodels-lm, echo = FALSE, fig.height = 2.5, out.width = "100%", fig.align = "center"}
par(mfrow = c(1, 4), bg = "#f7f7f7")
make_topmodels_plot(LM)
par(mfrow = c(1, 1))
```

#### Heteroscedastic truncated regression with a logistic distribution assumption
```{r topmodels-trch, echo = FALSE, fig.height = 2.5, out.width = "100%", fig.align = "center"}
par(mfrow = c(1, 4), bg = "#f7f7f7")
make_topmodels_plot(TRCH)
par(mfrow = c(1, 1))
```

#### Heteroscedastic censored regression with a logistic distribution assumption
```{r topmodels-crch, echo = FALSE, fig.height = 2.5, out.width = "100%", fig.align = "center"}
par(mfrow = c(1, 4), bg = "#f7f7f7")
make_topmodels_plot(CRCH)
par(mfrow = c(1, 1))
```

```{r crch models-extended}
...
```{r topmodels-crchgau, echo = FALSE, fig.height = 2.5, out.width = "100%", fig.align = "center"}
par(mfrow = c(1, 4), bg = "#f7f7f7")
make_topmodels_plot(CRCHgau)
par(mfrow = c(1, 1))
```

#### Heteroscedastic censored regression with a student-t distribution assumption
```{r topmodels-crchstud, echo = FALSE, fig.height = 2.5, out.width = "100%", fig.align = "center"}
par(mfrow = c(1, 4), bg = "#f7f7f7")
make_topmodels_plot(CRCHstud)
par(mfrow = c(1, 1))
```
