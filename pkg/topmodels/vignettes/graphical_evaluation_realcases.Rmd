...
```{r topmodels-rootogram, echo = FALSE, fig.height = 6, out.width = "100%", fig.align = "center"}
...
```{r topmodels-pithist, echo = FALSE, fig.height = 4, out.width = "100%", fig.align = "center"}
...
```{r topmodels-wormplot, echo = FALSE, fig.height = 4, out.width = "100%", fig.align = "center"}
